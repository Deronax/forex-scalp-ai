...
# ENV
# ─────────────────────────────────────────────────────────
API_KEY = os.environ.get("API_KEY", "demo123")          # твой вътрешен ключ за бекенда
ALPHA_API_KEY = os.environ.get("ALPHA_API_KEY")         # Alpha Vantage ключ (имаш го)
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY")       # OpenAI ключ (добавен в Render)
...
# ─────────────────────────────────────────────────────────
# PLACEHOLDER /generate (оставен както беше)
# ─────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────
# NEW: /candles_alpha – свещи от Alpha Vantage
# ─────────────────────────────────────────────────────────
...
def candles_alpha(
    ...
    if key not in data:
        # когато удариш лимита, връщат {"Note": "..."} или {"Error Message": "..."}
...
# ─────────────────────────────────────────────────────────
# NEW: /llm_analyze – AI анализатор (строг JSON, прагове)
# ─────────────────────────────────────────────────────────
...
def llm_analyze(req: LLMReq, x_api_key: str = Header(None)):
    ...
    # компактни редове със свещи (последните 120 стигат)
    rows = ", ".join(
